window.onload = () => {
  ...
  div.innerHTML = 'hihi'
  // TODO button that sends an http get request to a route
  // query params contain start date and optional end date
  // the route sends a post request to github on behalf of the user
